#include <windows.h> //헤더 파일

//WinMain 함수에서 참조하므로 함수 원형을 선언한다.
LRESULT CALLBACK WndProc(HWND, UINT, WPARAM, LPARAM);

int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance,  //메인 함수
	LPSTR lpCmdLine, int nCmdShow)
{
	...
	//윈도우 클래스를 초기화하고 운영체제에 등록한다.            //윈도우 클래스 초기화와 등록
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT message,               //윈도우 프로시저
